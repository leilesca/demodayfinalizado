...
urlpatterns = [
    ...
    path('/guiaresultadosparque/', views.guiaresultadosparque, name="guiaresultadosparque"),
    path('/guiaresultadoslazer/', views.guiaresultadoslazer, name="guiaresultadoslazer"),
    path('/guiaresultadosoutros/', views.guiaresultadosoutros, name="guiaresultadosoutros"),
    path('/parceiras/', views.parceiras, name="parceiras"),
    path('/parceirasresultados/', views.parceirasresultados, name="parceirasresultados"),
    path('/parceirasresultadospersonal/', views.parceirasresultadospersonal, name="parceirasresultadospersonal"),
    path('/parceirasresultadospsicologa/', views.parceirasresultadospsicologa, name="parceirasresultadospsicologa"),
